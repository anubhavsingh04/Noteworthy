    ...
    <div className="py-28">
      <div className="flex justify-between items-center md:px-0 px-4">
        <div className="flex flex-1 flex-col items-center justify-center gap-2">
          <span className="sm:text-4xl text-logoText text-slate-400 font-bold">
            7x
          </span>
          <span className="text-slate-400 text-center sm:text-sm text-xs ">
      ...
      <div className="mt-10 md:px-0 px-4">
        <h3 className="text-slate-300 text-2xl font-semibold pb-5 pt-6">
          Metrics For Noteworthy
        </h3>

        <div className="flex md:flex-row flex-col md:gap-0 gap-16 justify-between">
          <ul className="list-disc sm:px-5 ps-10 text-slate-400 flex flex-col gap-5 flex-1 overflow-hidden">
